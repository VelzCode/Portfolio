    ...
    return (
        <section className="col-a">
            ...
            <div className="content-paragraph">
                <p className="content-p-header">My name is Jason<span className="content-p-focus"></span>, a Front-End Developer focused on building modern websites that look professional tailored to the customers needs, that perform well and make a strong first impression.</p>
